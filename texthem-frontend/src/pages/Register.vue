        ...
        <q-card v-bind:style="$q.screen.lt.sm ? { 'width': '80%' } : { 'width': '50%' }">
          ...
          <q-card-section>
            <q-form class="q-gutter-md" @submit.prevent="onSubmit">
              ...
              <q-input label="Email Adress" standout="bg-secondary text-black" v-model="email"></q-input>
              <q-input
                label="Password"
                type="password"
              ...
              ></q-input>
              <div>
                <q-btn class="full-width" color="primary" type="submit" label="Register" rounded />
